...
- **Live POC not for public consumption:** [`knowledge.demarkus.io`](https://knowledge.demarkus.io) (broker MCP gateway; join with a Claude Code plugin via `/knowledge-join`)
