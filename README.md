...
A live, public reference deployment of a [demarkus](https://github.com/latebit-io/demarkus)
knowledge system on GKE, managed entirely by GitOps. It doubles as a **GitHub
template** — fork it to stand up your own.

- **Live:** [`knowledge.demarkus.io`](https://knowledge.demarkus.io) (broker MCP gateway; join with a Claude Code plugin via `/knowledge-join`)
